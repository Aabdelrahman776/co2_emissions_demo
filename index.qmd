...
```{python}
# Load the data
emissions = pd.read_csv("/Users/ahmedabdelrahman776/Documents/GitHub/co2_emissions_demo/data/co2_cons.csv")
```
...
emissions_long["emissions"] = pd.to_numeric(emissions_long["emissions"].str.replace("−","-"))
...
countries_of_interest = ["India", "South Africa", "USA", "Saudi Arabia", "United Kingdom"]

filtered_data = emissions_long_1990_2022[emissions_long_1990_2022["country"].isin(countries_of_interest)]

# Create line chart. Year should be on the x-axis, emissions on the y-axis, and color should be by country.
fig_chart = px.line(filtered_data,x="year",y="emissions",color="country",title="C02 Emissions between 1990 and 2022")
